...
-- находок в topic_homework_ai_jobs. Применено оркестратором через MCP
-- 15.09.2026 (версия 20260915111443) до деплоя функции v17. Только
-- добавляющее: старый код на проде колонок не знает и продолжает работать.
