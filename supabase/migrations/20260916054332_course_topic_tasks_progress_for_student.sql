-- §182. Применена оркестратором через MCP 16.09.2026, версия 20260916054332.
-- Проверена под ролями: ученик курса → 91 тема / 573 задачи / 2 закрыты;
-- ученик чужого курса → 0 строк; владелец → 0 строк.
