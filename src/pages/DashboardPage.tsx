...
export function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const routes: Record<string, string> = {
      student: '/student',
      teacher: '/teacher',
      // Маршрута /curator больше нет (снесён 2026-08-05): «Кабинет куратора»
      // стоял на легаси-механике и не показывал ничего. Единственный профиль
      // с ролью curator ведём на проверку ДЗ — новое кураторство работает
      // там. Пока курсов у него не назначено, список честно пуст.
      curator: '/homework-queue',
      admin: '/admin',
