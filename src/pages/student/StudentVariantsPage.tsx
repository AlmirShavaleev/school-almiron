...
import { BookOpen, Clock, Calendar, CheckCircle2, Loader2, AlertCircle, Lock, ArrowRight, Sparkles, Trash2, BarChart3 } from 'lucide-react'
    ...
    <div className="max-w-3xl mx-auto px-4 py-6">
      <div className="mb-6 space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Варианты, назначенные учителем. Подборки из каталога теперь сохраняются отдельно для PDF.</p>
        </div>
        ...
        <div className="flex items-center justify-between gap-6 flex-wrap">
          ...
          <Link
            ...
            className="inline-flex min-h-10 items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-slate-300 hover:text-slate-950"
          >
            <BarChart3 size={15} /> Аналитика по номерам
          </Link>
        </div>
      </div>
