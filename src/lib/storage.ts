...
export type PrivateBucket = 'homeworks' | 'course-materials' | 'lesson-library' | 'topic-materials' | 'course-lesson-materials' | 'topic-homework' | 'topic-homework-attempts' | 'mock-exams'
